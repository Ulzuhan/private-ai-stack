...
|---|---|---|
| [Ollama](https://ollama.com) | `ollama/ollama:0.33.0` | Local inference, shared by the whole stack |
| model-init (one-shot) | `ollama/ollama:0.33.0` | Pulls the models on first `up` — keeps the quickstart a single command |
